...
const CartProductContent = () => {
  ...
  return (
    <div className="grid lg:grid-cols-6 gap-4 md:gap-6 md:py-5">
      {/* Cart items */}
      <div className="order-2 bg-white shadow-md border border-gray-300 rounded-xl p-3 sm:p-5 flex lg:col-span-4 flex-col gap-6 py-5">
      ...
      {/* Summary */}
      <div className="bg-white shadow-md border border-gray-300 rounded-xl p-4 sm:p-5 order-1 lg:order-3 lg:col-span-2 space-y-2 font-medium">
